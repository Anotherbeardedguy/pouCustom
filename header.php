...
<body <?php body_class( 'bg-gray-100 font-sans leading-normal text-gray-800 flex w-fullantialiased' ); ?>>
			...
			<div class="lg:flex lg:justify-between lg:items-center border-b py-6">
				...
				wp_nav_menu(
					array(
						...
						'container_class' => 'hidden bg-[#f3f1eb] mt-4 p-4 lg:mt-0 lg:p-0 lg:bg-transparent lg:block',
